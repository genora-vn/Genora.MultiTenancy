-- Repair ONLY the Test1 tenant database where all HLG baseline objects are absent
...
-- After execution, rerun DbMigrator for all tenants.
SET NOCOUNT ON;
SET XACT_ABORT ON;

DECLARE @Apply bit = 0;
DECLARE @ExpectedDatabase sysname = N'Test1';

IF DB_NAME() <> @ExpectedDatabase
    THROW 51010, 'Wrong database for HLG Test1 schema repair.', 1;
