        ...
        <td style="padding:0;">
            <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border-collapse:collapse;">
                <tr style="background:#d8d8d8;">
                    ...
                    <td>{{ model.OldPlayDateText }}</td>
                </tr>
                <tr>
                    <td>Tee time đăng ký</td>
                    <td>{{ model.OldTeeTimeFromText }} - {{ model.OldTeeTimeToText }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Số lượng người chơi</td>
                    <td>{{ model.OldNumberOfGolfers }}</td>
                </tr>
                <tr>
                    <td>Loại khách</td>
                    <td>{{ model.OldCustomerTypeText }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Người chơi cùng</td>
                    <td>{{ if model.OldPlayersText != "" }}{{ model.OldPlayersText }}{{ else }}Không có{{ end }}</td>
                </tr>
                <tr>
                    <td>Chương trình ưu đãi</td>
                    <td>{{ if model.OldPromotionText != "" }}{{ model.OldPromotionText }}{{ else }}Không có{{ end }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Trạng thái booking</td>
                    <td>{{ model.OldStatusText }}</td>
                </tr>
                <tr>
                    <td>Tên người cập nhật (role)</td>
                    <td>{{ model.OldUpdatedByText }}</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:0;">
            <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border-collapse:collapse;">
                <tr style="background:#d8d8d8;">
                    <td width="38%">Ngày chơi</td>
                    <td>{{ model.NewPlayDateText }}</td>
                </tr>
                <tr>
                    <td>Tee time đăng ký</td>
                    <td>{{ model.NewTeeTimeFromText }} - {{ model.NewTeeTimeToText }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Số lượng người chơi</td>
                    <td>{{ model.NewNumberOfGolfers }}</td>
                </tr>
                <tr>
                    <td>Loại khách</td>
                    <td>{{ model.NewCustomerTypeText }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Người chơi cùng</td>
                    <td>{{ if model.NewPlayersText != "" }}{{ model.NewPlayersText }}{{ else }}Không có{{ end }}</td>
                </tr>
                <tr>
                    <td>Chương trình ưu đãi</td>
                    <td>{{ if model.NewPromotionText != "" }}{{ model.NewPromotionText }}{{ else }}Không có{{ end }}</td>
                </tr>
                <tr style="background:#d8d8d8;">
                    <td>Trạng thái booking</td>
                    <td>{{ model.NewStatusText }}</td>
                </tr>
                <tr>
                    <td>Tên người cập nhật (role)</td>
                    <td>{{ model.NewUpdatedByText }}</td>
                </tr>
            </table>
        </td>
    </tr>
            ...
            <table width="100%" cellpadding="4" cellspacing="0" border="0" style="border-collapse:collapse;">
                ...
                {{ else }}
                    <tr>
                        ...
                        <td><b>{{ model.PricePerGolferText }} x {{ model.NewNumberOfGolfers }}</b></td>
                    </tr>
                {{ end }}
                ...
                <tr>
                    ...
                    <td>{{ model.NewPaymentMethodText }}</td>
                </tr>
            </table>
        </td>
    </tr>
