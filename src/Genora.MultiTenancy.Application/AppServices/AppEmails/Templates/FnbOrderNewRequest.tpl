...
<table cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;border-collapse:collapse;font-family:Arial,sans-serif;font-size:14px;color:#333333;border:1px solid #b7b7b7;margin:0 auto;">
    <!-- HEADER -->
    <tr>
        <td style="background:#1b4332;color:#ffffff;text-align:center;padding:16px;font-size:18px;font-weight:700;text-transform:uppercase;letter-spacing:0.5px;">
            THÔNG BÁO ĐƠN HÀNG F&B MỚI
        </td>
    </tr>
    <tr>
        <td style="background:#2d6a4f;color:#ffffff;text-align:center;padding:16px;font-size:13px;font-weight:600;">
            DỊCH VỤ ẨM THỰC SÂN GOLF
        </td>
    </tr>
    ...
    <!-- THÔNG TIN ĐƠN HÀNG -->
    <tr>
        <td style="background:#d8f3dc;padding:8px 12px;font-weight:700;text-transform:uppercase;color:#1b4332;border-bottom:1px solid #b7e4c7;">
            THÔNG TIN ĐƠN HÀNG
        </td>
    </tr>
    <tr>
        <td style="padding:0;">
            <table width="100%" cellpadding="6" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
                <tr style="background:#f4f9f4;">
                    ...
                    <td><b style="color:#1b4332;font-size:14px;">{{ order_code }}</b></td>
                </tr>
                <tr>
                    <td style="font-weight:600;">Mã Bag Tag (Thẻ túi):</td>
                    <td><span style="background:#e8f5e9;color:#1b4332;padding:3px 10px;border-radius:12px;font-weight:bold;border:1px solid #b7e4c7;">{{ bag_tag }}</span></td>
                </tr>
                <tr style="background:#f4f9f4;">
    ...
    <tr>
        <td style="padding:0;">
            <table width="100%" cellpadding="6" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
                ...
                <tr style="background:#f4f9f4;">
                    <td style="font-weight:600;">Ghi chú / Vị trí giao:</td>
                    <td>
                        {{ if note != null && note != "" }}
    ...
    <tr>
        <td style="background:#d8f3dc;padding:8px 12px;font-weight:700;text-transform:uppercase;color:#1b4332;border-bottom:1px solid #b7e4c7;">
            CHI TIẾT MÓN ({{ items_list ? (items_list | array.size) : 0 }})
        </td>
    </tr>
    <tr>
        <td style="padding:0;">
            <table width="100%" cellpadding="6" cellspacing="0" border="1" bordercolor="#e0e0e0" style="border-collapse:collapse;font-size:13px;">
                <thead>
                    <tr style="background:#2d6a4f;color:#ffffff;text-align:left;">
                        <th style="padding:8px;">Tên món / Đồ uống</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding:8px;">
                            <b style="color:#1b4332;">{{ item_name }}</b>
    ...
    <tr>
        <td style="padding:0;">
            <table width="100%" cellpadding="6" cellspacing="0" border="0" style="border-collapse:collapse;font-size:13px;">
                ...
                <tr style="background:#d8f3dc;font-size:14px;">
                    <td style="font-weight:700;color:#1b4332;">Tổng cộng:</td>
                    <td style="font-weight:700;color:#1b4332;font-size:16px;">{{ total_amount_text }}</td>
                </tr>
            </table>
        </td>
    </tr>
    ...
    <tr>
        <td style="padding:16px 8px;text-align:center;font-style:italic;font-weight:700;color:#555555;background:#f9f9f9;border-top:1px solid #e0e0e0;">
            Vui lòng kiểm tra và chuẩn bị món để phục vụ khách hàng kịp thời!
        </td>
    </tr>
</table>