...
{
    [BindProperty]
    public EditStylistViewModel Stylist { get; set; } = new();
    ...
    {
        var dto = await _stylistAppService.GetAsync(id);
    ...
    public async Task<IActionResult> OnPostAsync()
    {
        ...
        var updateDto = new UpdateSalonBeautyStylistDto
        {
            ...
            IsUploadImage = Stylist.IsUploadImage,
            Phone = Stylist.Phone,
            ...
            IsShowOnApp = Stylist.IsShowOnApp,
            Note = Stylist.Note,
