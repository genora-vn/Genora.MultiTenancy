...
- **✅ Báo cáo phân bổ nhóm tuổi (P6, 2026-09-07):** `GetAgeGroupStatsAsync` (query Participant group theo `AgeGroup`, lọc `JoinedTime`, đủ 4 nhóm + tỷ lệ %) + DTO `Hl25AgeGroupStatsDto` + interface. UI Reports thêm card doughnut Chart.js + bảng. Bộ CURL API 9 endpoint đã cập nhật theo thiết kế mới. Build 0 errors.
