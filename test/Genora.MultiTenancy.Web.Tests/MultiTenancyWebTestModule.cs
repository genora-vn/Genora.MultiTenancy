...
[DependsOn(
    ...
    typeof(MultiTenancyWebModule),
    typeof(MultiTenancyApplicationTestModule),
    typeof(MultiTenancyEntityFrameworkCoreTestModule)
)]
public class MultiTenancyWebTestModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            builder.PartManager.ApplicationParts.Add(new CompiledRazorAssemblyPart(typeof(MultiTenancyWebModule).Assembly));
        });
